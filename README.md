...
(10 rows)
```
Результат запроса включает соединение всех строк одного экземпляра таблицы _airports_data_ со всеми строками второго экземпляра без каких либо условий.
