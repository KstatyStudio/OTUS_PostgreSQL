...
(22 rows)
```
Стоимость выполнения запроса 92.49, время выполнеия - 0,223 миллисекунды. Стоимость и время выполнения запроса выросли. Сканирование выполняется по всем секциям. Секционирование по составному атрибуту в данном случае не привело к повышению производительности.
...
(16 rows)
```
Стоимость выполнения запроса 43.97, время выполнеия - 0,169 миллисекунды. Стоимость запроса практически не изменилась. Время выполнения запроса незначительно сократилось. Сканирование выполняется по партиции, а не по всей таблице. Возможно, при росте объёма данных рост производительности будет заметнее.
