...
```
Система идентифицирует взаимную блокировку транзакций и приостанавливает выполнение транзакции в **сессии #1**. При этом блокировки установленные в **сесии #1** отменяются и запрос в **сесии #2** выполняется: 
```diff
!UPDATE 1
```
