...
-postgres@vmotus1:/home/devops$ pg_createcluster -d /var/lib/postgresql/14/main4 14 main4
-Creating new PostgreSQL cluster 14/main4 ...
-/usr/lib/postgresql/14/bin/initdb -D /var/lib/postgresql/14/main4 --auth-local peer --auth-host scram-sha-256 --no-instructions
-The files belonging to this database system will be owned by user "postgres".
-This user must also own the server process.
...
-fixing permissions on existing directory /var/lib/postgresql/14/main4 ... ok
-creating subdirectories ... ok
-selecting dynamic shared memory implementation ... posix
-selecting default max_connections ... 100
-selecting default shared_buffers ... 128MB
...
-  sudo systemctl daemon-reload
-Ver Cluster Port Status Owner    Data directory               Log file
-14  main4   5435 down   postgres /var/lib/postgresql/14/main4 /var/log/postgresql/postgresql-14-main4.log
```

Удаляем каталог кластера _main4_:
```diff
