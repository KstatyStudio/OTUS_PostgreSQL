...
(16 rows)
```
Время выполнения запроса незначительно сократилось. Сканирование выполняется по партиции, а не по всей таблице. Возможно, при росте объёма данных рост производительности будет заметнее.
