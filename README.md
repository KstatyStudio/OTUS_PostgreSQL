...
Транзакция в сессии #3 (pid = 147916) ожидает снятия блокировок, наложенных процессом в сессии #2 (pid = 147821), а так же блокировка tuple ExclusiveLock не получила разрешения (granted false).
